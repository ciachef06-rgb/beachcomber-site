    ...
    <div id="top" className="min-h-screen bg-[#FFF4E2] text-[#07313B]">
      <header className="sticky top-0 z-50 border-b border-orange-100 bg-[#FFF4E2]/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 md:px-8">
          ...
          <a href="#contact" className="hidden rounded-full bg-[#07313B] px-8 py-4 text-lg font-black text-white shadow-lg transition hover:bg-[#0F6170] md:inline-flex">Order Catering</a>
